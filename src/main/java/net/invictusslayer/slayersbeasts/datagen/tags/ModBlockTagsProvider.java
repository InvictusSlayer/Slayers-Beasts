...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        ...
        this.tag(BlockTags.SAPLINGS).add(ModBlocks.ASPEN_SAPLING.get(), ModBlocks.CAJOLE_SAPLING.get(), ModBlocks.EUCALYPTUS_SAPLING.get(), ModBlocks.REDWOOD_SAPLING.get());
        this.tag(BlockTags.LEAVES).add(ModBlocks.ASPEN_LEAVES.get(), ModBlocks.CAJOLE_LEAVES.get(), ModBlocks.EUCALYPTUS_LEAVES.get(), ModBlocks.REDWOOD_LEAVES.get());
        this.tag(BlockTags.LOGS_THAT_BURN).addTag(ModTags.Blocks.ASPEN_LOGS).addTag(ModTags.Blocks.CAJOLE_LOGS).addTag(ModTags.Blocks.EUCALYPTUS_LOGS).addTag(ModTags.Blocks.REDWOOD_LOGS);
        this.tag(BlockTags.PLANKS).add(ModBlocks.ASPEN_PLANKS.get(), ModBlocks.CAJOLE_PLANKS.get(), ModBlocks.EUCALYPTUS_PLANKS.get(), ModBlocks.REDWOOD_PLANKS.get());
        this.tag(BlockTags.WOODEN_SLABS).add(ModBlocks.ASPEN_SLAB.get(), ModBlocks.CAJOLE_SLAB.get(), ModBlocks.EUCALYPTUS_SLAB.get(), ModBlocks.REDWOOD_SLAB.get());
        this.tag(BlockTags.WOODEN_STAIRS).add(ModBlocks.ASPEN_STAIRS.get(), ModBlocks.CAJOLE_STAIRS.get(), ModBlocks.EUCALYPTUS_STAIRS.get(), ModBlocks.REDWOOD_STAIRS.get());
        this.tag(BlockTags.WOODEN_FENCES).add(ModBlocks.ASPEN_FENCE.get(), ModBlocks.CAJOLE_FENCE.get(), ModBlocks.EUCALYPTUS_FENCE.get(), ModBlocks.REDWOOD_FENCE.get());
        this.tag(BlockTags.WOODEN_BUTTONS).add(ModBlocks.ASPEN_BUTTON.get(), ModBlocks.CAJOLE_BUTTON.get(), ModBlocks.EUCALYPTUS_BUTTON.get(), ModBlocks.REDWOOD_BUTTON.get());
        this.tag(BlockTags.WOODEN_PRESSURE_PLATES).add(ModBlocks.ASPEN_PRESSURE_PLATE.get(), ModBlocks.CAJOLE_PRESSURE_PLATE.get(), ModBlocks.EUCALYPTUS_PRESSURE_PLATE.get(), ModBlocks.REDWOOD_PRESSURE_PLATE.get());
        this.tag(BlockTags.WOODEN_DOORS).add(ModBlocks.ASPEN_DOOR.get(), ModBlocks.CAJOLE_DOOR.get(), ModBlocks.EUCALYPTUS_DOOR.get(), ModBlocks.REDWOOD_DOOR.get());
        this.tag(BlockTags.WOODEN_TRAPDOORS).add(ModBlocks.ASPEN_TRAPDOOR.get(), ModBlocks.CAJOLE_TRAPDOOR.get(), ModBlocks.EUCALYPTUS_TRAPDOOR.get(), ModBlocks.REDWOOD_TRAPDOOR.get());
        this.tag(BlockTags.FENCE_GATES).add(ModBlocks.ASPEN_FENCE_GATE.get(), ModBlocks.CAJOLE_FENCE_GATE.get(), ModBlocks.EUCALYPTUS_FENCE_GATE.get(), ModBlocks.REDWOOD_FENCE_GATE.get());
