...
public class SBPois {
    ...
    public static final RegistryObject<PoiType> ANTHILL_POI = POIS.register("anthill_poi",
            () -> new PoiType(ImmutableSet.copyOf(SBBlocks.ANTHILL.get().getStateDefinition().getPossibleStates()), 0, 1));

    public static final RegistryObject<PoiType> SEPULCHRA_PORTAL = POIS.register("sepulchra_portal",
            () -> new PoiType(ImmutableSet.copyOf(SBBlocks.SEPULCHRA_PORTAL.get().getStateDefinition().getPossibleStates()), 0, 1));
