...
public class SBBlockTagsProvider extends BlockTagsProvider {
	...
	protected void addTags(HolderLookup.Provider pProvider) {
		...
		tag(BlockTags.STANDING_SIGNS).add(SBBlocks.ASPEN_SIGN.get(), SBBlocks.DESERT_OAK_SIGN.get(), SBBlocks.EUCALYPTUS_SIGN.get(), SBBlocks.KAPOK_SIGN.get(), SBBlocks.REDWOOD_SIGN.get(), SBBlocks.WILLOW_SIGN.get());
		tag(BlockTags.WALL_SIGNS).add(SBBlocks.ASPEN_WALL_SIGN.get(), SBBlocks.DESERT_OAK_WALL_SIGN.get(), SBBlocks.EUCALYPTUS_WALL_SIGN.get(), SBBlocks.KAPOK_WALL_SIGN.get(), SBBlocks.REDWOOD_WALL_SIGN.get(), SBBlocks.WILLOW_WALL_SIGN.get());
		tag(BlockTags.CEILING_HANGING_SIGNS).add(SBBlocks.ASPEN_HANGING_SIGN.get(), SBBlocks.DESERT_OAK_HANGING_SIGN.get(), SBBlocks.EUCALYPTUS_HANGING_SIGN.get(), SBBlocks.KAPOK_HANGING_SIGN.get(), SBBlocks.REDWOOD_HANGING_SIGN.get(), SBBlocks.WILLOW_HANGING_SIGN.get());
		tag(BlockTags.WALL_HANGING_SIGNS).add(SBBlocks.ASPEN_WALL_HANGING_SIGN.get(), SBBlocks.DESERT_OAK_WALL_HANGING_SIGN.get(), SBBlocks.EUCALYPTUS_WALL_HANGING_SIGN.get(), SBBlocks.KAPOK_WALL_HANGING_SIGN.get(), SBBlocks.REDWOOD_WALL_HANGING_SIGN.get(), SBBlocks.WILLOW_WALL_HANGING_SIGN.get());
