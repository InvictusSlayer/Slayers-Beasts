...
public class AntSoldierModel<T extends AntSoldier> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition antenna_left = body.addOrReplaceChild("antenna_left", CubeListBuilder.create(), PartPose.offset(0.0F, -7.75F, -8.0F));

		PartDefinition cube_r7 = antenna_left.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(16, 35).addBox(0.0F, -4.75F, 0.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.25F, 0.25F, -0.75F, 0.6981F, -0.0873F, 0.1745F));

		PartDefinition cube_r8 = antenna_left.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(8, 35).addBox(-0.1148F, -5.3024F, -1.0981F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.25F, -3.75F, -2.75F, 1.3963F, -0.2618F, 0.1745F));

		PartDefinition antenna_right = body.addOrReplaceChild("antenna_right", CubeListBuilder.create(), PartPose.offset(0.0F, -7.25F, -8.0F));

		PartDefinition cube_r9 = antenna_right.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(34, 35).addBox(-1.0F, -4.75F, 0.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.25F, -0.25F, -0.75F, 0.6981F, 0.0873F, -0.1745F));

		PartDefinition cube_r10 = antenna_right.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(12, 35).addBox(-0.8852F, -5.3024F, -1.0981F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.25F, -4.25F, -2.75F, 1.3963F, 0.2618F, -0.1745F));
		...
		PartDefinition cube_r11 = leg_left_front.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(19, 34).addBox(0.0F, -1.0F, 0.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 0.0F, -0.5F, 0.0F, 0.0F, -1.5708F));
		...
		PartDefinition cube_r12 = leg_left_mid.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(32, 19).addBox(0.0F, -1.0F, 0.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 0.0F, -0.5F, 0.0F, 0.0F, -1.5708F));
		...
		PartDefinition cube_r13 = leg_left_hind.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(9, 22).addBox(0.0F, -1.0F, 0.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 0.0F, -0.5F, 0.0F, 0.0F, -1.5708F));
		...
		PartDefinition cube_r14 = leg_right_front.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(27, 34).addBox(-3.0F, -1.0F, 0.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, 0.0F, -0.5F, 0.0F, 0.0F, 1.5708F));
		...
		PartDefinition cube_r15 = leg_right_mid.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(34, 33).addBox(-3.0F, -1.0F, 0.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, 0.0F, -0.5F, 0.0F, 0.0F, 1.5708F));
		...
		PartDefinition cube_r16 = leg_right_hind.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(0, 35).addBox(-3.0F, -1.0F, 0.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, 0.0F, -0.5F, 0.0F, 0.0F, 1.5708F));
