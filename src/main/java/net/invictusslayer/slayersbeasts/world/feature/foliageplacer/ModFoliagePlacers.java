...
public class ModFoliagePlacers {
    ...
    public static final RegistryObject<FoliagePlacerType<?>> ASPEN_FOLIAGE_PLACER = FOLIAGE_PLACERS.register("aspen_foliage_placer", () -> new FoliagePlacerType<>(AspenFoliagePlacer.CODEC));
