...
import net.invictusslayer.slayersbeasts.world.feature.tree.foliageplacer.*;
import net.invictusslayer.slayersbeasts.world.feature.tree.trunkplacer.ColossalTrunkPlacer;
import net.invictusslayer.slayersbeasts.world.feature.tree.trunkplacer.CrossTrunkPlacer;
...
public class SBConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> MEDIUM_BLACK_MUSHROOM = createKey("medium_black_mushroom");
    public static final ResourceKey<ConfiguredFeature<?, ?>> MEDIUM_BROWN_MUSHROOM = createKey("medium_brown_mushroom");
    public static final ResourceKey<ConfiguredFeature<?, ?>> MEDIUM_RED_MUSHROOM = createKey("medium_red_mushroom");
    public static final ResourceKey<ConfiguredFeature<?, ?>> MEDIUM_WHITE_MUSHROOM = createKey("medium_white_mushroom");
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, HUGE_BLACK_MUSHROOM, SBFeatures.HUGE_BLACK_MUSHROOM.get(), new HugeMushroomFeatureConfiguration(BlockStateProvider.simple(SBBlocks.BLACK_MUSHROOM_BLOCK.get().defaultBlockState()), BlockStateProvider.simple(Blocks.MUSHROOM_STEM.defaultBlockState()), 3));
        register(context, HUGE_WHITE_MUSHROOM, SBFeatures.HUGE_WHITE_MUSHROOM.get(), new HugeMushroomFeatureConfiguration(BlockStateProvider.simple(SBBlocks.WHITE_MUSHROOM_BLOCK.get().defaultBlockState()), BlockStateProvider.simple(Blocks.MUSHROOM_STEM.defaultBlockState()), 3));
        register(context, MEDIUM_BLACK_MUSHROOM, SBFeatures.MEDIUM_MUSHROOM.get(), new MediumMushroomFeature.Configuration(UniformInt.of(1, 2), BlockStateProvider.simple(SBBlocks.BLACK_MUSHROOM_BLOCK.get()), BlockStateProvider.simple(Blocks.MUSHROOM_STEM)));
        register(context, MEDIUM_BROWN_MUSHROOM, SBFeatures.MEDIUM_MUSHROOM.get(), new MediumMushroomFeature.Configuration(UniformInt.of(1, 2), BlockStateProvider.simple(Blocks.BROWN_MUSHROOM_BLOCK), BlockStateProvider.simple(Blocks.MUSHROOM_STEM)));
        register(context, MEDIUM_RED_MUSHROOM, SBFeatures.MEDIUM_MUSHROOM.get(), new MediumMushroomFeature.Configuration(UniformInt.of(1, 2), BlockStateProvider.simple(Blocks.RED_MUSHROOM_BLOCK), BlockStateProvider.simple(Blocks.MUSHROOM_STEM)));
        ...
        register(context, STYPHIUM_PATCH, SBFeatures.STYPHIUM_PATCH.get(), new StyphiumPatchFeature.Configuration(PlacementUtils.inlinePlaced(configured.getOrThrow(VEGETATION_STYPHIUM)), 0.15F, 6, UniformInt.of(4, 7), 0.3F, true));
        register(context, STYPHIUM_PATCH_BONEMEAL, SBFeatures.STYPHIUM_PATCH.get(), new StyphiumPatchFeature.Configuration(PlacementUtils.inlinePlaced(configured.getOrThrow(TINY_MUSHROOMS)), 0.05F, 4, UniformInt.of(1, 2), 0.75F, false));
