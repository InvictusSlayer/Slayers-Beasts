...
public class SBStructureSets {
    ...
    public static void bootstrap(BootstapContext<StructureSet> context) {
        ...
        register(context, CRYPT_ENTRANCES, structures.getOrThrow(SBStructures.CRYPT_ENTRANCE), new RandomSpreadStructurePlacement(32, 8, RandomSpreadType.LINEAR, 987654001));
    }
