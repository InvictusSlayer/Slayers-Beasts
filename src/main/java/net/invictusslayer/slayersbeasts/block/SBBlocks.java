...
public final class SBBlocks {
    ...
    public static final RegistryObject<Block> ASPEN_BUTTON = register("aspen_button", () -> woodenButton(BlockBehaviour.Properties.copy(Blocks.OAK_BUTTON), SBBlockSets.ASPEN));
    public static final RegistryObject<Block> ASPEN_PRESSURE_PLATE = register("aspen_pressure_plate", () -> woodenPressurePlate(BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE), SBBlockSets.ASPEN));
    public static final RegistryObject<Block> ASPEN_DOOR = register("aspen_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR), SBBlockSets.ASPEN));
    public static final RegistryObject<Block> ASPEN_TRAPDOOR = register("aspen_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR), SBBlockSets.ASPEN));
    ...
    public static final RegistryObject<Block> CAJOLE_BUTTON = register("cajole_button", () -> woodenButton(BlockBehaviour.Properties.copy(Blocks.OAK_BUTTON), SBBlockSets.CAJOLE));
    public static final RegistryObject<Block> CAJOLE_PRESSURE_PLATE = register("cajole_pressure_plate", () -> woodenPressurePlate(BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE), SBBlockSets.CAJOLE));
    public static final RegistryObject<Block> CAJOLE_DOOR = register("cajole_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR), SBBlockSets.CAJOLE));
    public static final RegistryObject<Block> CAJOLE_TRAPDOOR = register("cajole_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR), SBBlockSets.CAJOLE));
    ...
    public static final RegistryObject<Block> DESERT_OAK_BUTTON = register("desert_oak_button", () -> woodenButton(BlockBehaviour.Properties.copy(Blocks.OAK_BUTTON), SBBlockSets.DESERT_OAK));
    public static final RegistryObject<Block> DESERT_OAK_PRESSURE_PLATE = register("desert_oak_pressure_plate", () -> woodenPressurePlate(BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE), SBBlockSets.DESERT_OAK));
    public static final RegistryObject<Block> DESERT_OAK_DOOR = register("desert_oak_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR), SBBlockSets.DESERT_OAK));
    public static final RegistryObject<Block> DESERT_OAK_TRAPDOOR = register("desert_oak_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR), SBBlockSets.DESERT_OAK));
    ...
    public static final RegistryObject<Block> EUCALYPTUS_BUTTON = register("eucalyptus_button", () -> woodenButton(BlockBehaviour.Properties.copy(Blocks.OAK_BUTTON), SBBlockSets.EUCALYPTUS));
    public static final RegistryObject<Block> EUCALYPTUS_PRESSURE_PLATE = register("eucalyptus_pressure_plate", () -> woodenPressurePlate(BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE), SBBlockSets.EUCALYPTUS));
    public static final RegistryObject<Block> EUCALYPTUS_DOOR = register("eucalyptus_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR), SBBlockSets.EUCALYPTUS));
    public static final RegistryObject<Block> EUCALYPTUS_TRAPDOOR = register("eucalyptus_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR), SBBlockSets.EUCALYPTUS));
    ...
    public static final RegistryObject<Block> KAPOK_BUTTON = register("kapok_button", () -> woodenButton(BlockBehaviour.Properties.copy(Blocks.OAK_BUTTON), SBBlockSets.KAPOK));
    public static final RegistryObject<Block> KAPOK_PRESSURE_PLATE = register("kapok_pressure_plate", () -> woodenPressurePlate(BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE), SBBlockSets.KAPOK));
    public static final RegistryObject<Block> KAPOK_DOOR = register("kapok_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR), SBBlockSets.KAPOK));
    public static final RegistryObject<Block> KAPOK_TRAPDOOR = register("kapok_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR), SBBlockSets.KAPOK));
    ...
    public static final RegistryObject<Block> REDWOOD_BUTTON = register("redwood_button", () -> woodenButton(BlockBehaviour.Properties.copy(Blocks.OAK_BUTTON), SBBlockSets.REDWOOD));
    public static final RegistryObject<Block> REDWOOD_PRESSURE_PLATE = register("redwood_pressure_plate", () -> woodenPressurePlate(BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE), SBBlockSets.REDWOOD));
    public static final RegistryObject<Block> REDWOOD_DOOR = register("redwood_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR), SBBlockSets.REDWOOD));
    public static final RegistryObject<Block> REDWOOD_TRAPDOOR = register("redwood_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR), SBBlockSets.REDWOOD));
    ...
    public static final RegistryObject<Block> WILLOW_BUTTON = register("willow_button", () -> woodenButton(BlockBehaviour.Properties.copy(Blocks.OAK_BUTTON), SBBlockSets.WILLOW));
    public static final RegistryObject<Block> WILLOW_PRESSURE_PLATE = register("willow_pressure_plate", () -> woodenPressurePlate(BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE), SBBlockSets.WILLOW));
    public static final RegistryObject<Block> WILLOW_DOOR = register("willow_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR), SBBlockSets.WILLOW));
    public static final RegistryObject<Block> WILLOW_TRAPDOOR = register("willow_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR), SBBlockSets.WILLOW));
