...
import net.invictusslayer.slayersbeasts.init.SBModelLayers;
...
public class WoodFamily {
	...
	public static class Builder {
		...
		public Builder sapling(Supplier<Block> sapling) {
		...
		public Builder pottedSapling(Supplier<Block> pottedSapling) {
