...
public class SBWoodType {
	...
	public static final WoodType CAJOLE = register("aspen", SBBlockSetType.CAJOLE);
	...
	public static WoodType register(String name, BlockSetType setType) {
		WoodType woodType = new WoodType(SlayersBeasts.MOD_ID + ":" + name, setType);
