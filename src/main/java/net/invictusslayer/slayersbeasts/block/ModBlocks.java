...
public final class ModBlocks {
    ...
    public static final RegistryObject<Block> OOTHECA = registerBlock("ootheca", () -> new OothecaBlock(BlockBehaviour.Properties.of(Material.SCULK).strength(1f).noLootTable()));

    public static final RegistryObject<Block> ANT_SOIL = registerBlock("ant_soil", () -> new Block(BlockBehaviour.Properties.of(Material.GRASS).strength(1f).sound(SoundType.ROOTED_DIRT)));
    public static final RegistryObject<Block> ANTHILL = registerBlock("anthill", () -> new AnthillBlock(BlockBehaviour.Properties.of(Material.GRASS).strength(1f).sound(SoundType.ROOTED_DIRT)));
    public static final RegistryObject<Block> ANTHILL_HATCHERY = registerBlock("anthill_hatchery", () -> new AnthillHatcheryBlock(BlockBehaviour.Properties.of(Material.GRASS).strength(1f).sound(SoundType.ROOTED_DIRT)));

    public static final RegistryObject<Block> BLACK_SAND = registerBlock("black_sand", () -> new SandBlock(3748886, BlockBehaviour.Properties.of(Material.SAND, MaterialColor.COLOR_BLACK).strength(0.5F).sound(SoundType.SAND)));
    ...
    public static final RegistryObject<Block> CAJOLE_STAIRS = registerBlock("cajole_stairs", () -> new ModFlammableStairBlock(() -> ModBlocks.CAJOLE_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.OAK_STAIRS), 20, 5));
    ...
    public static final RegistryObject<Block> EUCALYPTUS_STAIRS = registerBlock("eucalyptus_stairs", () -> new ModFlammableStairBlock(() -> ModBlocks.CAJOLE_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.OAK_STAIRS), 20, 5));
    ...
    public static final RegistryObject<Block> ASPEN_STAIRS = registerBlock("aspen_stairs", () -> new ModFlammableStairBlock(() -> ModBlocks.ASPEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.OAK_STAIRS), 20, 5));
