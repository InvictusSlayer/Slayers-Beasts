...
import net.invictusslayer.slayersbeasts.item.CryptPortalItem;
import net.invictusslayer.slayersbeasts.item.SBConsumables;
import net.invictusslayer.slayersbeasts.item.SBFoods;
...
public class SBItems {
	//? if neoforge
	/*public static final net.neoforged.neoforge.registries.DeferredRegister<Item> ITEMS = net.neoforged.neoforge.registries.DeferredRegister.create(Registries.ITEM, SlayersBeasts.MOD_ID);*/
	...
	public static final Supplier<Item> ALGAE = register("algae", new PlaceOnWaterBlockItem(SBBlocks.ALGAE.get(), new Item.Properties().setId(createKey("algae"))));
	...
	private static <T extends Item> Supplier<T> register(String name, T item) {
		//? if fabric
		return () -> Registry.register(BuiltInRegistries.ITEM, ResourceLocation.fromNamespaceAndPath(SlayersBeasts.MOD_ID, name), item);
		//? if neoforge
	...
	public static void init() {
		SlayersBeasts.LOGGER.info("Initialised Items");
	}
}
