package net.invictusslayer.slayersbeasts.world.level.gen.feature.tree;
...
public class SBTreeGrowers {
	...
	public static final TreeGrower CYPRESS = new TreeGrower("cypress", 0.1F, Optional.empty(), Optional.empty(), Optional.of(SBConfiguredFeatures.CYPRESS), Optional.empty(), Optional.empty(), Optional.empty());
