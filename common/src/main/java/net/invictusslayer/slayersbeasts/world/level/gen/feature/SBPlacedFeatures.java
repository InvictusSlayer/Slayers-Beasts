...
public class SBPlacedFeatures {
	...
	private static void registerWithModifier(BootstrapContext<PlacedFeature> context, ResourceKey<PlacedFeature> key, Holder<ConfiguredFeature<?, ?>> config, PlacementModifier... modifiers) {
		registerWithModifier(context, key, config, List.of(modifiers));
	}

	private static void registerWithModifier(BootstrapContext<PlacedFeature> context, ResourceKey<PlacedFeature> key, Holder<ConfiguredFeature<?, ?>> config, List<PlacementModifier> modifiers) {
