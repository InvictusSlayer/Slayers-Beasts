...
public class SBFoods {
	...
	public static final FoodProperties INSECT_EYE = new FoodProperties.Builder().nutrition(2).saturationModifier(0.8F).effect(new MobEffectInstance(MobEffects.POISON, 100, 0), 0.5F).build();
}
