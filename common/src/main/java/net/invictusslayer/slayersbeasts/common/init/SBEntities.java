...
public class SBEntities {
	...
	public static <T extends Entity> Supplier<EntityType<T>> register(String name, EntityType.Builder<T> builder) {
		return SlayersBeasts.PLATFORM.register(BuiltInRegistries.ENTITY_TYPE, name, () -> builder.build(ResourceKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(SlayersBeasts.MOD_ID, name))));
	}
