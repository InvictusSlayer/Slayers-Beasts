...
public class SBSounds {
	...
	private static Supplier<Holder.Reference<SoundEvent>> registerHolder(String name) {
		return SlayersBeasts.PLATFORM.registerHolder(BuiltInRegistries.SOUND_EVENT, name, () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(SlayersBeasts.MOD_ID, name)));
	}

	private static Supplier<SoundEvent> register(String name) {
		return SlayersBeasts.PLATFORM.register(BuiltInRegistries.SOUND_EVENT, name, () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(SlayersBeasts.MOD_ID, name)));
	}
