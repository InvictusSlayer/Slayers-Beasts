...
public class SBItems {
	...
	public static final RegistrySupplier<Item> MANTIS_SPAWN_EGG = ITEMS.register("mantis_spawn_egg", () -> new ArchitecturySpawnEggItem(SBEntities.MANTIS, 0xffffff, 0xffffff, new Item.Properties()));
	...
	public static final RegistrySupplier<Item> WITHER_SPIDER_SPAWN_EGG = ITEMS.register("wither_spider_spawn_egg", () -> new ArchitecturySpawnEggItem(SBEntities.WITHER_SPIDER, 0xffffff, 0xffffff, new Item.Properties()));
	public static final RegistrySupplier<Item> TYRACHNID_SPAWN_EGG = ITEMS.register("tyrachnid_spawn_egg", () -> new ArchitecturySpawnEggItem(SBEntities.TYRACHNID, 0xffffff, 0xffffff, new Item.Properties()));
	public static final RegistrySupplier<Item> DAMSELFLY_SPAWN_EGG = ITEMS.register("damselfly_spawn_egg", () -> new ArchitecturySpawnEggItem(SBEntities.DAMSELFLY, 0xffffff, 0xffffff, new Item.Properties()));
	public static final RegistrySupplier<Item> ENT_SPAWN_EGG = ITEMS.register("ent_spawn_egg", () -> new ArchitecturySpawnEggItem(SBEntities.ENT_MEDIUM, 0xffffff, 0xffffff, new Item.Properties()));
	public static final RegistrySupplier<Item> WUDU_SPAWN_EGG = ITEMS.register("wudu_spawn_egg", () -> new ArchitecturySpawnEggItem(SBEntities.WUDU, 0xffffff, 0xffffff, new Item.Properties()));
	public static final RegistrySupplier<Item> SPORETRAP_SPAWN_EGG = ITEMS.register("sporetrap_spawn_egg", () -> new ArchitecturySpawnEggItem(SBEntities.SPORETRAP, 0xffffff, 0xffffff, new Item.Properties()));
	...
	public static final RegistrySupplier<Item> DESERT_OAK_BOAT = ITEMS.register("desert_oak_boat", () -> new BoatItem(false, SBBoatType.DESERT_OAK, new Item.Properties().stacksTo(1)));
	public static final RegistrySupplier<Item> DESERT_OAK_CHEST_BOAT = ITEMS.register("desert_oak_chest_boat", () -> new BoatItem(true, SBBoatType.DESERT_OAK, new Item.Properties().stacksTo(1)));
	...
	public static final RegistrySupplier<Item> EUCALYPTUS_BOAT = ITEMS.register("eucalyptus_boat", () -> new BoatItem(false, SBBoatType.EUCALYPTUS, new Item.Properties().stacksTo(1)));
	public static final RegistrySupplier<Item> EUCALYPTUS_CHEST_BOAT = ITEMS.register("eucalyptus_chest_boat", () -> new BoatItem(true, SBBoatType.EUCALYPTUS, new Item.Properties().stacksTo(1)));
	...
	public static final RegistrySupplier<Item> KAPOK_BOAT = ITEMS.register("kapok_boat", () -> new BoatItem(false, SBBoatType.KAPOK, new Item.Properties().stacksTo(1)));
	public static final RegistrySupplier<Item> KAPOK_CHEST_BOAT = ITEMS.register("kapok_chest_boat", () -> new BoatItem(true, SBBoatType.KAPOK, new Item.Properties().stacksTo(1)));
	...
	public static final RegistrySupplier<Item> REDWOOD_BOAT = ITEMS.register("redwood_boat", () -> new BoatItem(false, SBBoatType.REDWOOD, new Item.Properties().stacksTo(1)));
	public static final RegistrySupplier<Item> REDWOOD_CHEST_BOAT = ITEMS.register("redwood_chest_boat", () -> new BoatItem(true, SBBoatType.REDWOOD, new Item.Properties().stacksTo(1)));
	...
	public static final RegistrySupplier<Item> WILLOW_BOAT = ITEMS.register("willow_boat", () -> new BoatItem(false, SBBoatType.WILLOW, new Item.Properties().stacksTo(1)));
	public static final RegistrySupplier<Item> WILLOW_CHEST_BOAT = ITEMS.register("willow_chest_boat", () -> new BoatItem(true, SBBoatType.WILLOW, new Item.Properties().stacksTo(1)));
}
