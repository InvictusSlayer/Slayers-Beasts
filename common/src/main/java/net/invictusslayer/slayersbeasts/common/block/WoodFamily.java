...
public class WoodFamily {
	...
	public static class Builder {
		...
		public Builder hangingSign(RegistrySupplier<Block> hangingSign) {
			family.variants.put(Variant.HANGING_SIGN, hangingSign);
			return this;
		}

		public Builder hangingSignItem(RegistrySupplier<Item> hangingSign) {
		...
		public Builder sign(RegistrySupplier<Block> sign) {
			family.variants.put(Variant.SIGN, sign);
			return this;
		}

		public Builder signItem(RegistrySupplier<Item> sign) {
		...
		public Builder wallHangingSign(RegistrySupplier<Block> wallHangingSign) {
			family.variants.put(Variant.WALL_HANGING_SIGN, wallHangingSign);
			return this;
		}

		public Builder wallSign(RegistrySupplier<Block> wallSign) {
