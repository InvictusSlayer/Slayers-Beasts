...
public class WoodFamily {
	...
	public static final WoodFamily CYPRESS = builder().button(SBBlocks.CYPRESS_BUTTON).boat(SBItems.CYPRESS_BOAT, SBBoatType.CYPRESS).chestBoat(SBItems.CYPRESS_CHEST_BOAT).door(SBBlocks.CYPRESS_DOOR).fence(SBBlocks.CYPRESS_FENCE).fenceGate(SBBlocks.CYPRESS_FENCE_GATE).hangingSign(SBBlocks.CYPRESS_HANGING_SIGN, SBBlocks.CYPRESS_WALL_HANGING_SIGN, SBItems.CYPRESS_HANGING_SIGN).leaves(SBBlocks.CYPRESS_LEAVES).log(SBBlocks.CYPRESS_LOG, SBTags.Blocks.CYPRESS_LOGS, SBTags.Items.CYPRESS_LOGS).planks(SBBlocks.CYPRESS_PLANKS).pottedSapling(SBBlocks.POTTED_CYPRESS_SAPLING).pressurePlate(SBBlocks.CYPRESS_PRESSURE_PLATE).sapling(SBBlocks.CYPRESS_SAPLING).sign(SBBlocks.CYPRESS_SIGN, SBBlocks.CYPRESS_WALL_SIGN, SBItems.CYPRESS_SIGN).slab(SBBlocks.CYPRESS_SLAB).stairs(SBBlocks.CYPRESS_STAIRS).strippedLog(SBBlocks.STRIPPED_CYPRESS_LOG).strippedWood(SBBlocks.STRIPPED_CYPRESS_WOOD).trapdoor(SBBlocks.CYPRESS_TRAPDOOR).wood(SBBlocks.CYPRESS_WOOD).getFamily();
	...
	public static class Builder {
		...
		public Builder boat(RegistrySupplier<Item> boat, Boat.Type type) {
			family.variants.put(Variant.BOAT, boat);
			family.boatType = type;
			return this;
		}

		public Builder chestBoat(RegistrySupplier<Item> boat) {
