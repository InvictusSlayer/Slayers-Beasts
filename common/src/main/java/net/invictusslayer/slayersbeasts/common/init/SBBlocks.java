...
//	public static final RegistrySupplier<Block> THIN_MUSHROOM_STEM = register("thin_mushroom_stem", () -> new ThinMushroomStemBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.MUSHROOM_STEM).setId(createKey("thin_mushroom_stem"))));
	...
	public static final RegistrySupplier<Block> BLOODWOOD_LOG = register("bloodwood_log", () -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG).setId(createKey("bloodwood_log"))));
	public static final RegistrySupplier<Block> BLOODWOOD_WOOD = register("bloodwood_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD).setId(createKey("bloodwood_wood"))));
	public static final RegistrySupplier<Block> STRIPPED_BLOODWOOD_LOG = register("stripped_bloodwood_log", () -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG).setId(createKey("stripped_bloodwood_log"))));
	public static final RegistrySupplier<Block> STRIPPED_BLOODWOOD_WOOD = register("stripped_bloodwood_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD).setId(createKey("stripped_bloodwood_wood"))));
	public static final RegistrySupplier<Block> BLOODWOOD_LEAVES = register("bloodwood_leaves", () -> new LeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES).setId(createKey("bloodwood_leaves"))));
	public static final RegistrySupplier<Block> BLOODWOOD_SAPLING = register("bloodwood_sapling", () -> new SaplingBlock(SBTreeGrowers.BLOODWOOD, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SAPLING).setId(createKey("bloodwood_sapling"))));
	public static final RegistrySupplier<Block> POTTED_BLOODWOOD_SAPLING = BLOCKS.register("potted_bloodwood_sapling", () -> new FlowerPotBlock(BLOODWOOD_SAPLING.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING).setId(createKey("potted_bloodwood_sapling"))));
	public static final RegistrySupplier<Block> BLOODWOOD_PLANKS = register("bloodwood_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).setId(createKey("bloodwood_planks"))));
	public static final RegistrySupplier<Block> BLOODWOOD_STAIRS = register("bloodwood_stairs", () -> new StairBlock(BLOODWOOD_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_STAIRS).setId(createKey("bloodwood_stairs"))));
	public static final RegistrySupplier<Block> BLOODWOOD_SLAB = register("bloodwood_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SLAB).setId(createKey("bloodwood_slab"))));
	public static final RegistrySupplier<Block> BLOODWOOD_FENCE = register("bloodwood_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_FENCE).setId(createKey("bloodwood_fence"))));
	public static final RegistrySupplier<Block> BLOODWOOD_FENCE_GATE = register("bloodwood_fence_gate", () -> new FenceGateBlock(SBWoodType.BLOODWOOD, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_FENCE_GATE).setId(createKey("bloodwood_fence_gate"))));
	public static final RegistrySupplier<Block> BLOODWOOD_DOOR = register("bloodwood_door", () -> new DoorBlock(SBBlockSetType.BLOODWOOD, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_DOOR).setId(createKey("bloodwood_door"))));
	public static final RegistrySupplier<Block> BLOODWOOD_TRAPDOOR = register("bloodwood_trapdoor", () -> new TrapDoorBlock(SBBlockSetType.BLOODWOOD, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_TRAPDOOR).setId(createKey("bloodwood_trapdoor"))));
	public static final RegistrySupplier<Block> BLOODWOOD_PRESSURE_PLATE = register("bloodwood_pressure_plate", () -> woodenPressurePlate(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PRESSURE_PLATE).setId(createKey("bloodwood_pressure_plate")), SBBlockSetType.BLOODWOOD));
	public static final RegistrySupplier<Block> BLOODWOOD_BUTTON = register("bloodwood_button", () -> woodenButton(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_BUTTON).setId(createKey("bloodwood_button")), SBBlockSetType.BLOODWOOD));
	public static final RegistrySupplier<Block> BLOODWOOD_SIGN = BLOCKS.register("bloodwood_sign", () -> new StandingSignBlock(SBWoodType.BLOODWOOD, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN).setId(createKey("bloodwood_sign"))));
	public static final RegistrySupplier<Block> BLOODWOOD_WALL_SIGN = BLOCKS.register("bloodwood_wall_sign", () -> new WallSignBlock(SBWoodType.BLOODWOOD, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN).setId(createKey("bloodwood_wall_sign"))));
	public static final RegistrySupplier<Block> BLOODWOOD_HANGING_SIGN = BLOCKS.register("bloodwood_hanging_sign", () -> new CeilingHangingSignBlock(SBWoodType.BLOODWOOD, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_HANGING_SIGN).setId(createKey("bloodwood_hanging_sign"))));
	public static final RegistrySupplier<Block> BLOODWOOD_WALL_HANGING_SIGN = BLOCKS.register("bloodwood_wall_hanging_sign", () -> new WallHangingSignBlock(SBWoodType.BLOODWOOD, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN).setId(createKey("bloodwood_wall_hanging_sign"))));
	...
	public static final RegistrySupplier<Block> POTTED_CAJOLE_SAPLING = BLOCKS.register("potted_cajole_sapling", () -> new FlowerPotBlock(CAJOLE_SAPLING.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING).setId(createKey("potted_cajole_sapling"))));
	...
	public static final RegistrySupplier<Block> CYPRESS_LOG = register("cypress_log", () -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG).setId(createKey("cypress_log"))));
	public static final RegistrySupplier<Block> CYPRESS_WOOD = register("cypress_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD).setId(createKey("cypress_wood"))));
	public static final RegistrySupplier<Block> STRIPPED_CYPRESS_LOG = register("stripped_cypress_log", () -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG).setId(createKey("stripped_cypress_log"))));
	public static final RegistrySupplier<Block> STRIPPED_CYPRESS_WOOD = register("stripped_cypress_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD).setId(createKey("stripped_cypress_wood"))));
	public static final RegistrySupplier<Block> CYPRESS_LEAVES = register("cypress_leaves", () -> new LeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES).setId(createKey("cypress_leaves"))));
	public static final RegistrySupplier<Block> CYPRESS_SAPLING = register("cypress_sapling", () -> new SaplingBlock(SBTreeGrowers.CYPRESS, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SAPLING).setId(createKey("cypress_sapling"))));
	public static final RegistrySupplier<Block> POTTED_CYPRESS_SAPLING = BLOCKS.register("potted_cypress_sapling", () -> new FlowerPotBlock(CYPRESS_SAPLING.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING).setId(createKey("potted_cypress_sapling"))));
	public static final RegistrySupplier<Block> CYPRESS_PLANKS = register("cypress_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).setId(createKey("cypress_planks"))));
	public static final RegistrySupplier<Block> CYPRESS_STAIRS = register("cypress_stairs", () -> new StairBlock(CYPRESS_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_STAIRS).setId(createKey("cypress_stairs"))));
	public static final RegistrySupplier<Block> CYPRESS_SLAB = register("cypress_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SLAB).setId(createKey("cypress_slab"))));
	public static final RegistrySupplier<Block> CYPRESS_FENCE = register("cypress_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_FENCE).setId(createKey("cypress_fence"))));
	public static final RegistrySupplier<Block> CYPRESS_FENCE_GATE = register("cypress_fence_gate", () -> new FenceGateBlock(SBWoodType.CYPRESS, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_FENCE_GATE).setId(createKey("cypress_fence_gate"))));
	public static final RegistrySupplier<Block> CYPRESS_DOOR = register("cypress_door", () -> new DoorBlock(SBBlockSetType.CYPRESS, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_DOOR).setId(createKey("cypress_door"))));
	public static final RegistrySupplier<Block> CYPRESS_TRAPDOOR = register("cypress_trapdoor", () -> new TrapDoorBlock(SBBlockSetType.CYPRESS, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_TRAPDOOR).setId(createKey("cypress_trapdoor"))));
	public static final RegistrySupplier<Block> CYPRESS_PRESSURE_PLATE = register("cypress_pressure_plate", () -> woodenPressurePlate(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PRESSURE_PLATE).setId(createKey("cypress_pressure_plate")), SBBlockSetType.CYPRESS));
	public static final RegistrySupplier<Block> CYPRESS_BUTTON = register("cypress_button", () -> woodenButton(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_BUTTON).setId(createKey("cypress_button")), SBBlockSetType.CYPRESS));
	public static final RegistrySupplier<Block> CYPRESS_SIGN = BLOCKS.register("cypress_sign", () -> new StandingSignBlock(SBWoodType.CYPRESS, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN).setId(createKey("cypress_sign"))));
	public static final RegistrySupplier<Block> CYPRESS_WALL_SIGN = BLOCKS.register("cypress_wall_sign", () -> new WallSignBlock(SBWoodType.CYPRESS, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN).setId(createKey("cypress_wall_sign"))));
	public static final RegistrySupplier<Block> CYPRESS_HANGING_SIGN = BLOCKS.register("cypress_hanging_sign", () -> new CeilingHangingSignBlock(SBWoodType.CYPRESS, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_HANGING_SIGN).setId(createKey("cypress_hanging_sign"))));
	public static final RegistrySupplier<Block> CYPRESS_WALL_HANGING_SIGN = BLOCKS.register("cypress_wall_hanging_sign", () -> new WallHangingSignBlock(SBWoodType.CYPRESS, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN).setId(createKey("cypress_wall_hanging_sign"))));
	...
	public static final RegistrySupplier<Block> WILLOW_LEAVES = register("willow_leaves", () -> new WillowLeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES).setId(createKey("willow_leaves"))));
