...
public class SBItems {
    public static final Supplier<Item> MUSIC_DISC_INKISH = register("music_disc_inkish", () -> new Item(new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    ...
    public static final Supplier<SpawnEggItem> SNAIL_SPAWN_EGG = registerSpawnEgg("snail_spawn_egg", SBEntities.SNAIL::get, 0xffffff, 0xffffff, new Item.Properties());
