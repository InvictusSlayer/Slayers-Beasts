...
public class SBEntities {
    ...
    public static final Supplier<EntityType<Snail>> SNAIL = register("snail", EntityType.Builder.of(Snail::new, MobCategory.AMBIENT).sized(0.3F,0.4F));
    ...
    public static <T extends Mob> void registerSpawns(Consumer<SpawnPlacement<T>> consumer) {
        consumer.accept((SpawnPlacement<T>) new SpawnPlacement<>(MANTIS.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.WORLD_SURFACE, Mantis::canSpawn));
        consumer.accept((SpawnPlacement<T>) new SpawnPlacement<>(ANT_WORKER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.WORLD_SURFACE, AntWorker::canSpawn));
        consumer.accept((SpawnPlacement<T>) new SpawnPlacement<>(ANT_SOLDIER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.WORLD_SURFACE, AntSoldier::canSpawn));
        consumer.accept((SpawnPlacement<T>) new SpawnPlacement<>(ANT_QUEEN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.WORLD_SURFACE, AntQueen::canSpawn));
        consumer.accept((SpawnPlacement<T>) new SpawnPlacement<>(WITHER_SPIDER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.WORLD_SURFACE, WitherSpider::canSpawn));
        consumer.accept((SpawnPlacement<T>) new SpawnPlacement<>(BUTTERFLY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.WORLD_SURFACE, Butterfly::canSpawn));
        consumer.accept((SpawnPlacement<T>) new SpawnPlacement<>(DAMSELFLY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.WORLD_SURFACE, Damselfly::canSpawn));
        consumer.accept((SpawnPlacement<T>) new SpawnPlacement<>(SNAIL.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.WORLD_SURFACE, PathfinderMob::checkMobSpawnRules));
        consumer.accept((SpawnPlacement<T>) new SpawnPlacement<>(ENT_MEDIUM.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.WORLD_SURFACE, EntMedium::canSpawn));
        consumer.accept((SpawnPlacement<T>) new SpawnPlacement<>(SPORETRAP.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.WORLD_SURFACE, Sporetrap::canSpawn));
    }

    public record SpawnPlacement<T extends Mob>(EntityType<T> entity, SpawnPlacements.Type placement, Heightmap.Types heightmap, SpawnPlacements.SpawnPredicate<T> predicate) {}
    ...
    public static void registerAttributes(BiConsumer<EntityType<? extends LivingEntity>, AttributeSupplier> consumer) {
        ...
        consumer.accept(SNAIL.get(), Snail.createAttributes().build());
